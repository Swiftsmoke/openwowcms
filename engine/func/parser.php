...
//$smiley_text = array_map('htmlspecialchars', $smiley_text);
	...
	if (isset($inside))
	{
		...
		for ($i = 0; $i < $num_tokens; ++$i)
		{
			...
			if (isset($inside[$i]))
			{
				...
				$text .= '</p><div class="bbcode_codebox"><div class="bbcode_incqbox"><h4>Code:</h4><div class="bbcode_scrollbox" style="height: '.$height_str.'"><pre>'.$inside[$i].'</pre></div></div></div><p>';
			}
		}
	}
